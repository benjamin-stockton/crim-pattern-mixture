...
fit_lnh_mi <- brm_multiple(bf1,
           ...
           family = hurdle_lognormal(link = "identity", link_sigma = "log", link_hu = "logit"),
           prior = bprior2,
           chains = 1, cores = 124/2, iter = 1500, refresh = 100,
           init = 0,
           threads = threading(124/2),
           control = list(adapt_delta = 0.8, max_treedepth = 10),
           # file = "brms_fit/brms-hurlde-si.fit",
           # file_refit = "on_change",
           save_model = paste0("stan/brms-hurdle-lognormal-mi-scale-", s, ".stan"))

saveRDS(fit_lnh_mi, paste0("fits/sensitivity-analysis-fit-scale-", s, ".rds"))
...
saveRDS(res, paste0("fits/sensitivity-analysis-results-scale-", s, ".rds"))
